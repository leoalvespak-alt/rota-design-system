...
export const FEATURE_IDS = ['projects', 'autosave', 'safe-mutations', 'brand-lock', 'smart-layouts', 'quality-validator', 'campaign-presets', 'linked-components', 'content-library', 'command-center', 'reusable-data', 'batch-import', 'multiformat', 'ai-assistant', 'ai-carousel', 'variations', 'campaign-packages', 'workflow', 'planning', 'export-profiles', 'text-styles', 'conditional-composition'] as const
